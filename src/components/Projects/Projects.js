      ...
      <div className="container px-6 lg:px-8 mx-auto">
        ...
        <div className="grid grid-cols-3 gap-4 mt-16">
          <div className="bg-white p-3 rounded-lg text-primary-dark group">
            <div className="w-full relative h-[350px] overflow-hidden rounded-lg before:absolute before:z-10 before:w-full before:h-full before:group-hover:bg-black before:opacity-50 before:duration-300">
              <Image
          ...
          <div className="bg-white p-3 rounded-lg text-primary-dark group">
            <div className="w-full red-500 relative h-[350px] overflow-hidden rounded-lg before:absolute before:z-10 before:w-full before:h-full before:group-hover:bg-black before:opacity-50 before:duration-300">
              <Image
                className="rounded-lg group-hover:scale-110 duration-500 h-full w-full object-cover"
                src={projectImage3}
                alt="project image"
